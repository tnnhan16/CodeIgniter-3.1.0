...
<br />
<?php echo form_open_multipart('admin/user/insert/','class="form-horizontal"'); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <div class="form-group">
                    <div class="input-group col-5">
                        ...
                        <input name="username" class="form-control" type="text" value="<?php set_value('username') ?>">
                    </div>
                ...
                <div class="form-group">
                    <div class="input-group col-5">
                        ...
                        <input name="email" class="form-control" type="email" value="<?php set_value('email') ?>">
                    </div>
                    <div class="input-group col-12">
